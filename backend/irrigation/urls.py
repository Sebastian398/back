...
from .views import (SensorViewSet, ProgramacionRiegoViewSet, 
                    ...
                    LecturasHumedadCreateListView, EstadisticasHumedadSemanal, 
...
urlpatterns = [
    ...
    path('lecturas_humedad/', LecturasHumedadCreateListView.as_view(), name='lecturas-humedad'),
    ...
    path('bomba/', views.bomba_handler, name='bomba_handler'),
